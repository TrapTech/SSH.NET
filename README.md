...
This package is a **fork** of the original [SSH.NET](https://github.com/sshnet/SSH.NET) package.

It's published on nuget.org as a separate package under the `TrapTech.` prefix.
